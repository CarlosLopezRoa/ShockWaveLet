...
pre=['ER';];    %Subcarpetas a explorar
for im=1:1 %Ciclo general sobre las subcarpetas
    mat='/Volumes/LaCie/DatosTesis/Datos4/'; %El directorio donde se alojan
    %las subcarpetas
    ...
    cd (strcat('/Users/Poincare/Dropbox/MainWavelet/','DA'))
    %Cambia de directorio a donde se quiere escribir los archivos CSV%
    dd=100;     %270,380,590 %368          %Fotograma de inicio de interes
    uu=dd+550;  %70,90,125 %%220           %Fotograma de fin de interess
    ...
    while jj<=maxi                         %Segundo ciclo sobre los ensayos
        ...
        xlswrite(strcat('r',prefix,int2str(jj)),[time',r]) %Exporta r en CSV
